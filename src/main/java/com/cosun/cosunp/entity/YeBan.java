 ...
 * @Modified-date:
 */
public class YeBan implements Serializable {
    ...
    private String beginYeBanStr;
    private String endYeBanStr;
    ...
    public void setBeginYeBanStr(String beginYeBanStr) {
        this.beginYeBanStr = beginYeBanStr;
    }

    public String getEndYeBanStr() {
        return endYeBanStr;
    }

    public void setEndYeBanStr(String endYeBanStr) {
        this.endYeBanStr = endYeBanStr;
    }
